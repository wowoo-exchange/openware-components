...
import { GridItemProps } from '../../molecules';
...
interface GridProps {
    ...
    handleResize?: (layout: LayoutGrid, oldItem: React.FunctionComponent<GridItemProps>, newItem: React.FunctionComponent<GridItemProps>, placeholder: React.FunctionComponent<GridItemProps>, e: React.MouseEvent, element: HTMLElement) => void;
}
